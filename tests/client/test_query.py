...
def test_get_source_components_for_build():
    ...
    expected = {
        ('container', '4001'): {
            'artifact': Artifact.nodes.get(archive_id='4001'),
            'embeds': {
                ('container', '2001'): {
                    "artifact": Artifact.nodes.get(archive_id='2001'),
                    "embeds": {
                        ('rpm', '1001'): {
                            "artifact": Artifact.nodes.get(archive_id='1001'),
                            'sources': [
                                {
                                    'name': 'bash',
                                    'namespace': '',
                ...
                ('rpm', '3001'): {
                    'artifact': Artifact.nodes.get(archive_id='3001'),
                    'sources': [
                        {
                            'name': 'etcd',
                            'namespace': 'coreos',
